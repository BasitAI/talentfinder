...
Never return null, None, N/A, or empty score. Message must always be polite, concise, personalized.
""")
    ...
    def evaluate_candidate(state: CandidateState) -> CandidateState:
        try:
            ...
            try:
                ...
                return {**state, "score": score, "reason": reason, "message": message, "error": ""}
